...
<div id="updaterecordPacientAppointmentModalBox" class="modal fade" data-keyboard="false" data-backdrop="static">
		...
		<div class="modal-content">
			<form class="form" method="post" id="updaterecordPatientForm" action="/operator/register-journal-record-update">
				...
				<div class="modal-body record-pacient-modal-body">
					...
					<div class="col-xs-12">
						<div class="form-group">
							<label for="specialities">Специализация</label>
					...
					<div class="col-xs-12">
						<div class="form-group">
							<label for="doctors">Специалист</label>
